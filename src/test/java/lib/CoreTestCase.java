...
public class CoreTestCase{
    ...
    protected void rotateScreenLandscape() {
        if (driver instanceof AppiumDriver) {
            ...
            System.out.println("Method rotateScreenLandscape() dies nothing for platform " + Platform.getInstance().getPlatformVar());
        }
    }
    ...
    protected void backgroundApp(Integer seconds) {
        if (driver instanceof AppiumDriver) {
            ...
            System.out.println("Method backgroundApp() dies nothing for platform " + Platform.getInstance().getPlatformVar());
        }
    }
    ...
    protected void openWikiWebPageForMobileWeb() {
        if (Platform.getInstance().isMW()) {
            ...
            System.out.println("Method openWikiWebPageForMobileWeb() dies nothing for platform " + Platform.getInstance().getPlatformVar());
        }
    }
